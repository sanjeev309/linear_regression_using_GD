...
/*__________________          SANJEEV           ___________________________*/
...
void main(){
	...
	float data;
	int i,ch,epoch=0;
	float cost_prev=1000,cost_now;                           // Starting up with an arbitirarily high cost 
	...
	while(getch()){
	scanf("%d",&tempx);                  //Re-using variables
